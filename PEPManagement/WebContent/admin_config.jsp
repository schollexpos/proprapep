  ...
  <div class="container-fluid p-3">
    ...
    <div class="myrow mt-6">
        ...
        <div class="col-sm mt-3">
            <h3 class="inlabel text-center">Semester Abschließen?</h3>
            <input type ="button" class="wichtigUp w-100 mr-auto mt-1 wichtigUpbtn border border-dark" value ="Semster Abschließen!" >
        </div>
        <div class="col-sm">
        </div>
    </div>
